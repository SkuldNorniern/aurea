...
static const ng_platform_ops_t linux_ops = {
    ...
    .destroy_element = ng_linux_destroy_element,
    .detach_element = ng_linux_detach_element,
    ...
    .window_get_content_view = ng_linux_window_get_content_view,
    ...
    .create_text_field = ng_linux_create_text_field,
    ...
    .canvas_set_gpu_owned = ng_linux_canvas_set_gpu_owned,
